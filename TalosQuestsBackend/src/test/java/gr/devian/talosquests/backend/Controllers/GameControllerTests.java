 ...
 */
@Transactional
public class GameControllerTests extends AbstractUserControllerTest {
    ...
    public void testContinueByIdWithOtherUsersGameId() throws Exception {
        ...
        mockMvc.perform(get("/Game/Continue/"+game2.getId())
                .param("token",session.getToken()))
                .andExpect(status().isNotFound())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
                .andReturn();
    ...
    public void testContinueByIdWithValidId() throws Exception {
        ...
        mockMvc.perform(get("/Game/Continue/"+game.getId())
                .param("token",session.getToken()))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
                .andReturn();
    ...
    public void testDeleteByIdWithOtherUsersGameId() throws Exception {
        ...
        mockMvc.perform(get("/Game/Delete/"+game2.getId())
                .param("token",session.getToken()))
                .andExpect(status().isNotFound())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8))
                .andReturn();
